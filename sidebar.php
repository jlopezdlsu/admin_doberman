<nav class="col-md-3 col-lg-2 d-none d-md-block sidebar">
  <div class="sidebar-sticky">
    <ul class="nav flex-column">
      <li class="nav-item">
        <a href="#">
          <img src="https://s3.amazonaws.com/cdn-origin-etr.akc.org/wp-content/uploads/2017/11/12233854/Doberman-Pinscher-On-White-03.jpg" alt="" style="width:100%;padding: 2px;">
        </a>
      </li>
      <li class="nav-item">
